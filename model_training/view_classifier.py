...
功能：
1. 训练视角分类器模型（front、rear、standing、other）
...
def train_view_classifier(
    model_path: str,
    data_dir: str,
    output_base_dir: str = r"output_view",
    epochs: int = 100,
    imgsz: int = 640,
    batch: int = 16,
    device: int = 0
...
if __name__ == "__main__":
    ...
    # 加载训练好的模型进行预测
    # 注意：这里的run_1会根据实际训练生成的目录自动调整
    best_model_path = "output_view/run_1/weights/best.pt"
    test_dir = "dataset_view/test"
    trained_run_dir = 'output_view/run_1'
